export function Jumbotrom() {
	return (
		<section class="bg-center bg-no-repeat bg-[url('https://images.unsplash.com/photo-1577075473292-5f62dfae5522?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')] bg-gray-600 bg-blend-multiply mt-20">
			<div class='px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56'>
				<h1 class='mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl'>
					Sou Natalicio Rosa, Seu Corretor e Facilitador da APVS TRUCK
				</h1>
				<p class='mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48'>
					A Maior Associação de Proteção Veicular do Brasil
				</p>
